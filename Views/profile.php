    ...
    <?php include_once('../Views/common/side.php'); ?>
        <div class="main">
            ...
            <div class="profile-area">
                <div class="top">
                    <div class="user"><img src="<?php echo HOME_URL; ?>Views/img_uploaded/sample-person.jpg" alt=""></div>
                                ...
                                <div class="modal-content">
                                    <form action="profile.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="modal-body">
                                            <div class="user">
                                                <img src="<?php echo HOME_URL; ?>Views/img_uploaded/sample-person.jpg" alt="">
                                            </div>
                                            <div class="mb-3">
